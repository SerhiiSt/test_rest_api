 ...
 */
public class TwitterAssertExampleSoftAssertion {
    ...
    public void readTweet() {
        given()
                ...
                .body("user.name", hasItem("Serhii Shtelmakhs"),
                        "user.followers_count.size()",lessThan(20),
                        "user.profile_link_color", hasItem("1DA1F2"));
